...
class BabylmDataset(Dataset):
    ...
    def __init__(self, data_dir: str, seq_length: int, tokenizer, offset: int=0, random_chunk: bool=False, tokenizer_suffix: str=None):
        ...
        if tokenizer_suffix is not None:
            tokenizer_name += f"_{tokenizer_suffix}"
        ...
        if tokenized_file.exists():
            ...
            self.data = torch.load(tokenized_file, weights_only=True)
        else:
            data = []
